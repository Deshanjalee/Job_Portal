        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <select class="form-control  input-lg" id="province" name="province" required>
              ...
              <select class="form-control  input-lg" id="district" name="district" required>
...
<script>
  $("#province").on("change", function() {
    ...
    if(id != '') {
      $.post("district.php", {id: id}).done(function(data) {
