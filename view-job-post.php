          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <p><a href="mailto: cmis3214group2@gmail.com" class="btn btn-primary btn-flat" role="button">More Info</a>
                <hr>
                <div class="row">
                  <div class="col-md-4"><a href="sign-up.php"><i class="fa fa-address-card-o"></i> Apply</a></div>
                </div>
              </div>
            </div>
          </div>
