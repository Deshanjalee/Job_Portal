...
<div class="wrapper">
  ...
  <ul class="sci">
      <a href="https://facebook.com/" class="FaceBook"><img src="img/FaceBook.PNG" width=40px height=40px ><b>FaceBook</b></a> 
      <a href="https://instagram.com/" class="Instagram"><img src="img/instar.PNG" width=40px height=40px><b>instagram</b></a>
      <a href ="https://twitter.com/" class="Twitter"><img src="img/twitter.PNG" width=40px height= 40px><b>Twitter</b></a>
  </ul>
          ...
          */
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              <img class="attachment-img" src="img/photo1.jpg" alt="Attachment Image">
    ...
    <section id="company" class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Companies</h1>
            <p> Are you searching employee for hiring?</p>
            <p>Register your company for free, browse our talented pool, post and track job applications</p>            
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$mail->Username = 'thathsarasanduni@gmail.com';					//Sets SMTP username
		$mail->Password = 'nethsara';					//Sets SMTP password
		$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"
		$mail->From = $_POST["email"];					//Sets the From email address for the message
		$mail->FromName = $_POST["name"];				//Sets the From name of the message
		$mail->AddAddress('thathsarasanduni@gmail.com', 'Admin');		//Adds a "To" address
...
?>
     ...
     <div class="container">
			<div class="row">
				<div class="col-md-8" style="margin:0 auto; float:none;">
					<h1 align="center"><font size="12">Send Us a Message</font></h1>
					<br />
					<?php echo $error; ?>
					<form method="post">
  ...
  <footer class="main-footer" style="margin-left: 0px;" style="background-color: #330066">
    <div class="text-center" >
    <strong>Copyright &copy; 2021<a href="index.php">Job Portal</a>.</strong> All rights
    reserved.
