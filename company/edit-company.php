      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <p>In this section ,can change your company details</p>
            <div class="row">
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" id="district" name="district" placeholder="district" value="<?php echo $row['district']; ?>">
                  </div>
                  <div class="form-group">
