...
if(isset($_POST)) {
	...
	$jobtitle = mysqli_real_escape_string($conn, $_POST['jobtitle']);// job title
	$description = mysqli_real_escape_string($conn, $_POST['description']);//description
	$minimumsalary = mysqli_real_escape_string($conn, $_POST['minimumsalary']);// minimum salary
	$maximumsalary = mysqli_real_escape_string($conn, $_POST['maximumsalary']);//maximun salary
	$experience = mysqli_real_escape_string($conn, $_POST['experience']);// experience
	$qualification = mysqli_real_escape_string($conn, $_POST['qualification']); // qualification
