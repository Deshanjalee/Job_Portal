...
<div class="wrapper">
  ...
  <header class="main-header">
                    ...
                    <nav style="background-color: #00A65A">
                    <ul>
                        
                        
                      <span class="logo-lg"  style="font-size: 30px;" style="color: #000000"><b>Job Portal</b> </span>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <section id="candidates" class="content-header" style="background-color: #000000">
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2" style="background-color: #CCCCFF">
            <div class="pull-left">
          ...
          <div class="col-md-3" >
            <div class="thumbnail" style="background-color: #CCCCFF">
