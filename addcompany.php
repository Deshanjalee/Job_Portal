...
if(isset($_POST)) {
	...
	if($result->num_rows == 0) {
		...
		//sql new registration insert query
		$sql = "INSERT INTO company(name, companyname, province, district , city, contactno, website, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$province', '$district', '$city', '$contactno', '$website', '$email', '$password', '$aboutme', '$file')";
